...
export function generateChipData(stock, officialChip = null) {
  ...
  if (!officialChip) {
    return {
      ...
      isOfficial: false,
      dataDate: '',
      superLargePercent: null,
      largePercent: null,
      mediumPercent: null,
      retailPercent: null,
      below100Percent: null,
      cumulativeLargePercent: null,
  ...
  const last3DaysNet = dailyTrades.slice(-3).reduce((sum, day) => sum + (Number(day.netTotal) || 0), 0);
